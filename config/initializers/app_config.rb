...
APP_CONFIG = APP_CONFIG.deep_merge({
  ...
  parse: {
    ...
    building_clue_words: ['building', 'bldg', 'bldg.', 'lobby', 'in','from','inside','outside','of','by'],
    location_signal_words: ['lounge', 'lobby', 'inside', 'outside'],
    building_names: {
      'rotch' => '7A',
      'hayden' => '14',
      'dorrance' => '16',
    ...
    claimed_words: ['claimed', 'taken', 'gone', 'thanks for playing', 'thank you for playing']
  },
  router_nodes: {
